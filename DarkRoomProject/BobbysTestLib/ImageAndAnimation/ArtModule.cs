    ...
    public class ArtModule
    {
        ...
        public static void PrintAsciiFile()
        {
            try
            {
                ...
                string path = @"D:\REXPaint-v1.03\images\unnamed.png";
        ...
        {
            Bitmap bmpSource = new Bitmap(@"D:\Google Drive\WPF\TheDarkRoom\TheDarkRoom\DarkRoomProject\AsciiArt\Fire\SplitImages\tmp-0.gif", true);
            ConsoleWriteImage(bmpSource);
        }
